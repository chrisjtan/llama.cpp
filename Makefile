...
BUILD_TARGETS = \
	...
	retrieval speculative infill tokenize benchmark-matmult parallel finetune export-lora lookahead lookup passkey gritlm tests/test-c.o vit-cli \
# minicpmv-cli 
...
vit-cli: examples/vit_test/vit-cli.cpp examples/vit_test/vit_clip.h examples/vit_test/vit_clip.cpp examples/vit_test/vit.h examples/vit_test/vit.cpp examples/vit_test/vit_io.h examples/vit_test/vit_io.cpp ggml.o llama.o $(COMMON_DEPS) $(OBJS)
	$(CXX) $(CXXFLAGS) -c $< -o $(call GET_OBJ_FILE, $<)
	$(CXX) $(CXXFLAGS) -c examples/vit_test/vit_clip.cpp  -o $(call GET_OBJ_FILE, examples/vit_test/vit_clip.cpp) -Wno-cast-qual
	$(CXX) $(CXXFLAGS) -c examples/vit_test/vit.cpp -o $(call GET_OBJ_FILE, examples/vit_test/vit.cpp)
	$(CXX) $(CXXFLAGS) -c examples/vit_test/vit_io.cpp  -o $(call GET_OBJ_FILE, examples/vit_test/vit_io.cpp)
	$(CXX) $(CXXFLAGS) $(filter-out %.h $< examples/vit_test/vit_clip.cpp examples/vit_test/vit.cpp examples/vit_test/vit_io.cpp,$^) $(call GET_OBJ_FILE, $<) $(call GET_OBJ_FILE, examples/vit_test/vit_clip.cpp) $(call GET_OBJ_FILE, examples/vit_test/vit.cpp) $(call GET_OBJ_FILE, examples/vit_test/vit_io.cpp) -o $@ $(LDFLAGS)
